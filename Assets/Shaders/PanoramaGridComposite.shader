Shader "Hidden/PanoramaGridComposite"
{
    Properties
    {
        ...
        _Opacity ("Grid Opacity", Float) = 1.0 // <--- NEW PROPERTY
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float GetLineIntensity(float angle) {
                ...
                float targetPixelWidth = _Thickness;
            ...
            fixed4 frag (v2f i) : SV_Target {
                ...
                float strengthY = GetLineIntensity(atan2(dir.x, dir.z));
                float strengthX = GetLineIntensity(atan2(dir.y, dir.z));
                float strengthZ = GetLineIntensity(atan2(dir.y, dir.x));
